...
export function deriveCuratorPersona(draftedTracks: DraftedTrack[]): CuratorPersona {
  ...
  if (avgEnergy >= 84 || trapCount >= 3) {
    return {
      ...
      iconName: 'Flame',
      gradient: 'from-pink-600 via-red-600 to-purple-900',
      borderClass: 'border-pink-500/60 shadow-pink-950/50',
  ...
  if (vintageCount >= 3) {
    return {
      ...
      borderClass: 'border-yellow-500/60 shadow-yellow-950/40',
  ...
  if (rnbCount >= 2 || avgEnergy <= 68) {
    return {
      ...
      borderClass: 'border-indigo-500/60 shadow-indigo-950/40',
  ...
  if (isHighDiversity) {
    return {
      ...
      borderClass: 'border-cyan-500/60 shadow-cyan-950/40',
  ...
  return {
    ...
    iconName: 'Trophy',
    gradient: 'from-purple-600 via-pink-600 to-indigo-900',
    borderClass: 'border-purple-500/60 shadow-purple-950/40',
